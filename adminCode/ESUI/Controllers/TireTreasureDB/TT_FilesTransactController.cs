...
{
    //[Export]
    public class TT_FilesTransactController : JsonNetController
    {

      
       // [Dependency]
       // public TT_FilesTransactBiz OPBiz { get; set; }
        [Dependency]
        public ITT_FilesTransactDao OPBiz { get; set; }
        ...
        public JsonResult EditInfo(TT_FilesTransact EidModle)
        {
