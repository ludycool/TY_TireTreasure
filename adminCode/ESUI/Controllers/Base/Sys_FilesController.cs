...
{
    //[Export]
    public class Sys_FilesController : JsonNetController
    {

      
       // [Dependency]
       // public Sys_FilesBiz OPBiz { get; set; }
        [Dependency]
        public ISys_FilesDao OPBiz { get; set; }
        ...
        public JsonResult EditInfo(Sys_Files EidModle)
        {
            ...
            {
                EidModle.WhereExpression = Sys_FilesSet.FileId.Equal(EidModle.FileId);
        ...
        {
            var mql2 = Sys_FilesSet.SelectAll().Where(Sys_FilesSet.FileId.Equal(ID));
            Sys_Files Rmodel = OPBiz.GetEntity(mql2);
            //  groupsBiz.Add(rol);
