...
namespace Zephyr.Utils
{
    public partial class ZFiles
    {
        ...
        /// <param name="saveName">保存的文件名，如果是""则以原文件名保存</param>
        /// <returns></returns>
        public static HttpReSultMode FilesUpload(HttpPostedFile hpFile, string[] allowExtensions, int maxLength, string savePath, string saveName)
        {
            HttpReSultMode rsm = new HttpReSultMode();
        ...
        /// <param name="saveName">保存的文件名，如果是""则以原文件名保存</param>
        /// <returns></returns>
        public static HttpReSultMode ImageUpload(HttpPostedFile hpFile, int maxLength, string savePath, string saveName)
        {
            HttpReSultMode rsm = new HttpReSultMode();
