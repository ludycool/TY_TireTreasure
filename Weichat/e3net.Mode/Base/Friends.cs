...
namespace e3net.Mode.Base
{
    ...
    public partial class Friends : EntityBase
    {
        ...
        public Guid FriendsId
        {
            get
            {
                return GetPropertyValue<Guid>("FriendsId");
            }
            set
            {
                SetPropertyValue("FriendsId", value);
            }
        }
        ...
        public String SetName
        {
            get
            {
                return GetPropertyValue<String>("SetName");
            }
            set
            {
                SetPropertyValue("SetName", value);
            }
        }
        ...
        public String ByWay
        {
            get
            {
                return GetPropertyValue<String>("ByWay");
            }
            set
            {
                SetPropertyValue("ByWay", value);
            }
        }
        ...
        public Boolean? StarSign
        {
            get
            {
                return GetPropertyValue<Boolean?>("StarSign");
            }
            set
            {
                SetPropertyValue("StarSign", value);
            }
        }
        ...
        public Boolean? BlackList
        {
            get
            {
                return GetPropertyValue<Boolean?>("BlackList");
            }
            set
            {
                SetPropertyValue("BlackList", value);
            }
        }
        ...
        public String Remarks
        {
            get
            {
                return GetPropertyValue<String>("Remarks");
            }
            set
            {
                SetPropertyValue("Remarks", value);
            }
        }
        ...
        public DateTime? UpdateTime
        {
            get
            {
                return GetPropertyValue<DateTime?>("UpdateTime");
            }
            set
            {
                SetPropertyValue("UpdateTime", value);
            }
        }
    }
